...
def student_ranking(student_scores, student_names):
    ...
    return ([f'{index + 1}. {student_names}: {student_scores}'
            for index, (student_scores, student_names)
            in enumerate(zip(student_scores, student_names))])
...
def perfect_score(student_info):
    ...
    first_perfect_score = [student for student in student_info if student[1] == 100]
